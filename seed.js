...
pool.query(`INSERT INTO creature (name, alignment_id, type_id, health, exp, chal, descrip_id, stat_id, attack_id, spattack_id) VALUES
        ...
        ('Blight, Twig', 4, 13, 4, 25, 1/8, 14, 14, 14, 14),
        ('Blight, Vine', 2, 13, 26, 100, 1/2, 15, 15, 15, 15),
        ('Blight, Needle', 3, 13, 11, 50, 1/4, 16, 16, 16, 16),
        ('Bugbear', 2, 17, 27, 200, 1, 17, 17, 17, 17),
        ('Bugbear Chief', 4, 17, 65, 700, 3, 18, 18, 18, 18),
        ('Bulette', 2, 11, 94 1800, 5, 19, 19, 19, 19),
        ('Bullywug', 1, 10, 11, 50, 1/4, 20, 20, 20, 20),
